...
public class inputAndQuery {
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3306/streamdb?createDatabaseIfNotExist=true";

    static final String USER = "sarthak";
    ...
    static int saveSchema() {
        try {
            ...
            File file = new File("/Users/sarthakdandriyal/Desktop/dmproject/src/main/webapp/export.xml");
